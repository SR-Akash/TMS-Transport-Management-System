...
namespace TMS.Migrations
{
    ...
    [Migration("20210107101007_teacer")]
    partial class teacer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlankSpace.Models.Buses", b =>
                {
                    b.Property<int>("BusId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BlankSpace.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { UserId = 1, Password = "admin", RoleTypeId = 1, UserName = "admin@gmail.com" }
                    );
                });

            modelBuilder.Entity("BlankSpace.ViewModels.Expense", b =>
                {
            ...
            modelBuilder.Entity("BlankSpace.ViewModels.Notice", b =>
                {
            ...
            modelBuilder.Entity("BlankSpace.ViewModels.Student", b =>
                {
            ...
            modelBuilder.Entity("BlankSpace.ViewModels.Teacher", b =>
                {
            ...
            modelBuilder.Entity("BlankSpace.Models.AssignedDriver", b =>
                {
                    b.HasOne("BlankSpace.Models.Buses", "Bus")
                        .WithMany()
                        .HasForeignKey("BusId")
